...
export default function ReceiverFriends() {
  ...
  const checkReq = async () => {
    const res = await getReceiverReqs(user_id);
                ...
                value.status === "pending" && (
                  ...
                  >
                    ...
                    <div className="flex flex-col p-2 w-full text-white text-[10px] sm:text-sm md:text-md lg:text-lg">
                      ...
                      <div
                        className="p-1 sm:p-2 bg-neutral-700 rounded-md text-center mt-2 cursor-pointer text-[10px] sm:text-sm md:text-md lg:text-lg"
                        onClick={() =>
                          rejectRequest(value.sender.id, value.receiver.id)
                        }
                      >
                        <p>Delete</p>
                      </div>
